...
export class MainComponent implements OnInit, OnDestroy{
    ...
    constructor(public tourService: TourService, public menuItems: MenuItems, private breadcrumbService: BreadcrumbService, 
        private pageTitleService: PageTitleService, public translate: TranslateService,
         private router: Router, private media: ObservableMedia,private appService: AppService) {
...
getEnsure(){
    ...
    .subscribe(
        ...
        console.log("success")
        this.name= ensure.lastName+" "+ensure.firstName
